        ...
        !(function (e) {
          ...
          var t,
            ...
            T = function (e) {
              "hidden" === document.visibilityState &&
                h > -1 &&
                ((h = "visibilitychange" === e.type ? e.timeStamp : 0), b());
            },
            w = function () {
          ...
          _.push(
            function (e) {
              e.interactionId &&
                e.target &&
                !K.has(e.interactionId) &&
                K.set(e.interactionId, e.target);
            },
            function (e) {
              var t,
                ...
                q(function (t) {
                  var n = (function (e) {
                    var t = e.entries[0],
                      ...
                      l = [t.startTime + t.duration, o].concat(
                        s.map(function (e) {
                  ...
                  if (e.entries.length) {
                    ...
                    if (n) {
                      var i = n.activationStart || 0,
                        ...
                        u = Math.max(
                          s,
                          c ? (c.requestStart || c.startTime) - i : 0,
                        ),
          ...
          (t.buildTimingsObject = function (e, t, n) {
            for (var r = 0, i = n; r < i.length; r++) {
              var o = i[r],
                a = e[o];
              void 0 !== t &&
                (("number" != typeof a && "string" != typeof a) || (t[o] = a));
            }
          }),
          (t.timingsTargetKeys = [
            "navigationStart",
      ...
      791: function (e, t, n) {
        ...
        var h = function (e, t, n) {
          var r,
            ...
            a,
            c,
            s = null !== (r = null == e ? void 0 : e._v6) && void 0 !== r && r;
          if (e) {
            var u = Object.keys(e);
        ...
        var C = function (e) {
            var t = (function (e) {
                ...
                for (
                  var t = new Uint32Array(T(8 * e.length)).fill(0), n = 0;
                  n < e.length;
                  n++
                )
                  t[n >> 2] |= (255 & e[n]) << ((n % 4) * 8);
            ...
            return (function (e) {
              for (
                var t = new Uint8Array(4 * e.length), n = 0;
                n < 4 * e.length;
                n++
              )
                t[n] = (e[n >> 2] >>> ((n % 4) * 8)) & 255;
        ...
        !(function () {
          ...
          !(function () {
                    ...
                    var r = (function (n) {
                        ...
                        if ("function" == typeof u.getEntriesByType) {
                          ...
                          if (m && Array.isArray(m) && m.length > 0) {
                            ((l.timingsV2 = {}),
                              ...
                              delete l.timings);
                            var g = m[0];
                            (0, s.buildTimingsObject)(
                              g,
                              l.timingsV2,
                              s.timingsV2TargetKeys,
                            );
                          }
                        }
                      ...
                      return (
                        ...
                        p &&
                          ...
                          (l.siteToken = p.token)),
                        void 0 !== t && (delete l.timings, delete l.memory),
                        l
                      );
                    })(n);
                    r &&
              ...
              switch (
                ...
                case "INP":
                  (null == E.inp || Number(E.inp.value) < Number(e.value)) &&
                    ...
                    (c = e.attribution) &&
                      E.inp &&
                      ((E.inp.element = c.interactionTarget),
            ...
            function M() {
              if (p && p.serverTiming) {
                for (
                  ...
                  for (
                    var r = n[t], i = 0, o = u.getEntriesByType(r);
                    i < o.length;
                    i++
                  ) {
                    var a = o[i],
              ...
              if ("function" == typeof u.getEntriesByType) {
                ...
                ((e.timingsV2 = {}),
                  t &&
                    t[0] &&
                    (t[0].nextHopProtocol &&
                      (n.nextHopProtocol = t[0].nextHopProtocol),
                    t[0].transferSize && (n.transferSize = t[0].transferSize),
                    t[0].decodedBodySize &&
                      (n.decodedBodySize = t[0].decodedBodySize),
            ...
            function k(e) {
              ...
              if ("function" == typeof u.getEntriesByType) {
                var n =
                  null === (t = u.getEntriesByType("paint")) || void 0 === t
                    ? void 0
                    : t.filter(function (t) {
                        return t.name === e;
                      })[0];
